...
function M.compile(args)
  ...
  local command = (args ~= "" and args)
      or (detector and detector.cmd)
      or M.last_command
      or vim.o.makeprg
...
vim.api.nvim_create_user_command("CompileStop", function()
  M.stop()
end, {})
