...
-- Neogit
link('NeogitNormal', 'Normal')
link('NeogitNormalFloat', 'NormalFloat')
link('NeogitFloatBorder', 'FloatBorder')
link('NeogitWinSeparator', 'WinSeparator')
link('NeogitCursorLine', 'CursorLine')
link('NeogitCursorLineNr', 'CursorLineNr')
link('NeogitSubtleText', 'Comment')
hi(0, 'NeogitSectionHeader', { fg = c.yellow, bold = true })
hi(0, 'NeogitSectionHeaderCount', { fg = c.fg_light })
hi(0, 'NeogitStatusHEAD', { fg = c.fg_light, bold = true })
hi(0, 'NeogitBranch', { fg = c.green, bold = true })
hi(0, 'NeogitBranchHead', { fg = c.green, bold = true, underline = true })
hi(0, 'NeogitRemote', { fg = c.blue, bold = true })
hi(0, 'NeogitObjectId', { fg = c.blue })
hi(0, 'NeogitStash', { fg = c.yellow })
hi(0, 'NeogitTagName', { fg = c.yellow })
hi(0, 'NeogitTagDistance', { fg = c.cyan })
hi(0, 'NeogitRebaseDone', { fg = c.fg_dark })
hi(0, 'NeogitUnmergedInto', { fg = c.purple, bold = true })
hi(0, 'NeogitUnpushedTo', { fg = c.purple, bold = true })
hi(0, 'NeogitUnpulledFrom', { fg = c.purple, bold = true })

hi(0, 'NeogitChangeModified', { fg = c.blue, bold = true })
hi(0, 'NeogitChangeAdded', { fg = c.green, bold = true })
hi(0, 'NeogitChangeDeleted', { fg = c.red, bold = true })
hi(0, 'NeogitChangeRenamed', { fg = c.purple, bold = true })
hi(0, 'NeogitChangeUpdated', { fg = c.orange, bold = true })
hi(0, 'NeogitChangeCopied', { fg = c.cyan, bold = true })
hi(0, 'NeogitChangeUnmerged', { fg = c.yellow, bold = true })
hi(0, 'NeogitChangeNewFile', { fg = c.green, bold = true })

hi(0, 'NeogitHunkHeader', { fg = c.fg_light, bg = c.bg_alt, bold = true })
hi(0, 'NeogitHunkHeaderHighlight', { fg = c.yellow, bg = c.bg_status, bold = true })
link('NeogitHunkHeaderCursor', 'NeogitHunkHeaderHighlight')
hi(0, 'NeogitHunkMergeHeader', { fg = c.fg_light, bg = c.bg_alt, bold = true })
hi(0, 'NeogitHunkMergeHeaderHighlight', { fg = c.purple, bg = c.bg_status, bold = true })
link('NeogitHunkMergeHeaderCursor', 'NeogitHunkMergeHeaderHighlight')
hi(0, 'NeogitDiffContext', { bg = c.bg })
hi(0, 'NeogitDiffContextHighlight', { bg = c.bg_darker })
link('NeogitDiffContextCursor', 'NeogitDiffContextHighlight')
hi(0, 'NeogitDiffAdditions', { fg = c.green })
link('NeogitDiffAdd', 'DiffAdd')
hi(0, 'NeogitDiffAddHighlight', { fg = c.fg_light, bg = c.diff_add_bg, bold = true })
link('NeogitDiffAddCursor', 'NeogitDiffAddHighlight')
hi(0, 'NeogitDiffDeletions', { fg = c.red })
link('NeogitDiffDelete', 'DiffDelete')
hi(0, 'NeogitDiffDeleteHighlight', { fg = c.fg_light, bg = c.diff_delete_bg, bold = true })
link('NeogitDiffDeleteCursor', 'NeogitDiffDeleteHighlight')
hi(0, 'NeogitDiffAddInline', { fg = c.bg, bg = c.green, bold = true })
hi(0, 'NeogitDiffDeleteInline', { fg = c.bg, bg = c.red, bold = true })
hi(0, 'NeogitDiffHeader', { fg = c.blue, bg = c.bg_alt, bold = true })
hi(0, 'NeogitDiffHeaderHighlight', { fg = c.orange, bg = c.bg_status, bold = true })
link('NeogitDiffHeaderCursor', 'NeogitDiffHeaderHighlight')
hi(0, 'NeogitFilePath', { fg = c.blue })
hi(0, 'NeogitActiveItem', { fg = c.bg, bg = c.yellow, bold = true })

hi(0, 'NeogitPopupSectionTitle', { fg = c.yellow, bold = true })
hi(0, 'NeogitPopupBranchName', { fg = c.green, bold = true })
hi(0, 'NeogitPopupSwitchKey', { fg = c.purple })
hi(0, 'NeogitPopupOptionKey', { fg = c.purple })
hi(0, 'NeogitPopupConfigKey', { fg = c.purple })
hi(0, 'NeogitPopupActionKey', { fg = c.purple })
link('NeogitPopupSwitchEnabled', 'Added')
link('NeogitPopupOptionEnabled', 'Added')
link('NeogitPopupConfigEnabled', 'Added')
link('NeogitPopupSwitchDisabled', 'Comment')
link('NeogitPopupOptionDisabled', 'Comment')
link('NeogitPopupConfigDisabled', 'Comment')
link('NeogitPopupActionDisabled', 'Comment')

hi(0, 'NeogitGraphAuthor', { fg = c.orange })
hi(0, 'NeogitGraphRed', { fg = c.red })
hi(0, 'NeogitGraphWhite', { fg = c.fg_light })
hi(0, 'NeogitGraphYellow', { fg = c.yellow })
hi(0, 'NeogitGraphGreen', { fg = c.green })
hi(0, 'NeogitGraphCyan', { fg = c.cyan })
hi(0, 'NeogitGraphBlue', { fg = c.blue })
hi(0, 'NeogitGraphPurple', { fg = c.purple })
hi(0, 'NeogitGraphGray', { fg = c.fg_dark })
hi(0, 'NeogitGraphOrange', { fg = c.orange })
hi(0, 'NeogitGraphBoldRed', { fg = c.red, bold = true })
hi(0, 'NeogitGraphBoldWhite', { fg = c.fg_light, bold = true })
hi(0, 'NeogitGraphBoldYellow', { fg = c.yellow, bold = true })
hi(0, 'NeogitGraphBoldGreen', { fg = c.green, bold = true })
hi(0, 'NeogitGraphBoldCyan', { fg = c.cyan, bold = true })
hi(0, 'NeogitGraphBoldBlue', { fg = c.blue, bold = true })
hi(0, 'NeogitGraphBoldPurple', { fg = c.purple, bold = true })
hi(0, 'NeogitGraphBoldGray', { fg = c.fg_dark, bold = true })
hi(0, 'NeogitGraphBoldOrange', { fg = c.orange, bold = true })
